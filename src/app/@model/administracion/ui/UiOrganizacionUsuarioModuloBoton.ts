...
export class UiOrganizacionUsuarioModuloBoton {
    ListaOrganizacionUsuarioModulo?:OrganizacionXUsuarioXModulo[];
    ListaOrganizacionUsuarioModuloBoton?:OrganizacionXUsuarioXModuloXBoton[];
}