...
var oFacturaProveedorFormularioComponent: FacturaProveedorFormularioComponentPub, dtArticulos, dtArticulosHAS, dtClientes, dtGuias, dtBuscarAceptacionServicio, dtArchivos, archivo: Archivo;
@Component({
  moduleId: module.id,
