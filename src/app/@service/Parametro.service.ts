...
export class ParametroService {
  ...
  public crearParametro(parametros: Parametros) {
    return this.http.post(URL_EDITAR_PARAMETROS,parametros, this.header.getOptions([]))
      .catch(this.handleError);
  }

  public editarParametro(parametros: Parametros) {
    return this.http.put(URL_EDITAR_PARAMETROS,parametros, this.header.getOptions([]))
      .catch(this.handleError);
  }

  public eliminarParametro(parametros: Parametros) {
    return this.http.put(URL_EDITAR_PARAMETROS,parametros, this.header.getOptions([]))
      .catch(this.handleError);
  }
