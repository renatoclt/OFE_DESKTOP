...
import { CotizacionesEvaluarComponent } from './comprador/evaluar/cotizacionesevaluar.component';
...
@NgModule({
    ...
    declarations: [ CotizacionCompradorBuscarComponent,CotizacionCompradorFormularioComponent, CotizacionesEvaluarComponent,
        CotizacionProveedorBuscarComponent, CotizacionProveedorFormularioComponent]
})
