...
export class TransporteServicioCompradorFormularioComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.util.listMonedas(function (data: ComboItem[]) {
      oTransporteServicioCompradorFormularioComponent.listMonedaCombo = data;
    });

    this.util.listEstadoTTransporte(function (data: ComboItem[]) {
      oTransporteServicioCompradorFormularioComponent.listEstadoCombo = data;
    });

    oTransporteServicioCompradorFormularioComponent = this;
  }
