...
export class Servidores {
  ...
  // public server1 = 'http://35.196.243.220';
  // public server2 = 'http://104.196.1.181';
  public server1 = 'http://35.229.108.32';
  public server2 = 'http://35.196.21.141';
  ...
  //  SERVER 1
  public NOTIFIC    = this.server1 + ':8084/api/fe/ms-notificaciones/v1';
  public FILEQRY    = this.server1 + ':8083/api/fe/ms-archivos-query/v1';
  public INVEQRY    = this.server1 + ':8087/api/fe/ms-inveqry/v1';
  public DOCUCMD    = this.server1 + ':8086/api/fe/ms-documentos-command/v1';
  // public DOCUCMD    = 'http://192.168.70.24:8020/api/fe/ms-documentos-command/v1';

  //  SERVER 2
  public AFEDOCUQRY = this.server2 + ':8085/api/fe/ms-parametro-query/v1';
  public PARMQRY    = this.server2 + ':8085/api/fe/ms-parametro-query/v1';
  public DOCUQRY    = this.server2 + ':8081/api/fe/ms-documentos-query/v1';
  public ORGAQRY    = this.server2 + ':8088/api/fe/ms-organizaciones-command/v1';
  // public ORGAQRY  = this.serverorganizacionprueba + ':8088/api/fe/ms-organizaciones-command/v1';
  public ORGACMD    = this.server2 + ':8082/api/fe/ms-organizaciones-query/v1';
  public INVECMD    = this.server2 + ':8089/api/fe/ms-inventarios-command/v1';
